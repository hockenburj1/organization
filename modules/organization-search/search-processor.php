...
$tag_query = "SELECT DISTINCT tag.name FROM tag_membership as tm JOIN tag ON tm.tid = tag.tid WHERE name LIKE :term && tm.oid IN(SELECT oid from organization WHERE membership_requestable = 'TRUE')";
